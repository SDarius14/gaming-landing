      ...
      >
        ...
        >
          <div className="flex flex-col gap-5">
            ...
            <div>
              <p className="para2 font-jakarta text-sm md:max-w-xs lg:max-w-xl md:text-base lg:text-lg 2xl:text-xl">
          ...
          <div className="absolute top-80 md:top-44 xl:top-52 2xl:top-36">
